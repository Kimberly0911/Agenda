	...
	use CodeIgniter\Model;
 	...
 	class contactosModel extends Model{
 		public function listarContactos(){
 			$Contactos = $this->db->query('SELECT t_agenda.id_contacto, t_agenda.nombre, t_agenda.paterno, t_agenda.materno, t_agenda.telefono, t_agenda.email, t_agenda.id_categoria, t_agenda.fechaInsert, t_categoria.categoria FROM t_agenda, t_categorias where t_categorias.id_categoria=t_agenda.id_categoria');
